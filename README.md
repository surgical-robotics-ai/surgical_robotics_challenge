...
### 3c. Camera Coordinate frames
  To better understand the different camera coordinate frames and the difference between the AMBF convention and the Opencv convention, please refer to [camera_convention.md](./docs/camera_convention.md)
